...
let RefreshTokenUseCase = class RefreshTokenUseCase {
    ...
    execute(token) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const userToken = yield this.userTokensRepository.findByUserIdAndRefreshToken(sub, token);
            if (!userToken) {
            ...
            const newToken = (0, jsonwebtoken_1.sign)({ email }, auth_1.default.secret_token, {
                subject: sub,
