...
exports.usersRoutes.patch("/avatar", ensureAuthenticated_1.ensureAuthenticated, uploadAvatar.single("avatar"), updateUserAvatarController.handle);
exports.usersRoutes.get("/profile", ensureAuthenticated_1.ensureAuthenticated, profileUserController.handle);
