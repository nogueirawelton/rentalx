...
exports.router.use("/cars", cars_routes_1.carsRoutes);
exports.router.use("/rentals", rental_routes_1.rentalRoutes);
exports.router.use("/password", password_routes_1.passwordRoutes);
